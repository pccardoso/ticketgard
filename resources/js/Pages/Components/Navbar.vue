<template>
   ...
   <div class="bg-gray">
      <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar"
         ...
         class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-blue-800 rounded-lg sm:hidden hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200">
      ...
      <aside id="sidebar-multi-level-sidebar"
         ...
         <div class="h-full px-3 py-4 overflow-y-auto bg-blue-600">
            ...
            <ul class="space-y-2 font-medium">
               ...
               <li>
                  <Link href="/"
                     class="flex items-center p-2 text-white rounded-lg hover:bg-black group transition duration-400">
               ...
               <li>
                  <button type="button"
                     class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group hover:bg-black"
                     aria-controls="dropdown-meustickets" data-collapse-toggle="dropdown-meustickets">
               ...
               <li v-show="user.adm == 1">
                  <button type="button"
                     class="flex items-center w-full p-2 text-base text-white transition duration-400 rounded-lg group hover:bg-black "
               ...
               <li>
                  <button type="button"
                     class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group hover:bg-black"
                     aria-controls="dropdown-meusuario" data-collapse-toggle="dropdown-meusuario">
                     <svg class="w-6 h-6 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
      ...
      <div class="p-8 sm:ml-64 h-screen">
         ...
         <div class="flex flex-row space-x-2">
            ...
            <div class="inline-flex mb-2 text-white bg-blue-600 rounded-2xl p-1 pl-3 pr-3 shadow-lg">
               <IconUser class="text-color-500" />{{ user.name }}
            </div>

            <div v-if="user.vip"
               class="inline-flex ml-2 mb-2 text-white bg-yellow-400 rounded-2xl p-1 pl-3 pr-3 shadow-lg"
               title="Seu usuário é VIP"><img src="../../../img/vip.png.png" class="w-5 mr-1">Usuário VIP</div>


            <div class="relative inline-block">
               <!-- Botão -->

               <svg v-if="user.res_chamados" @click="showPopupNotification()" class="w-8 h-8 text-blue-800"
                  :class="controlHistoryNotification ? 'text-red-500 animate-pulse' : ''" aria-hidden="true"
               ...
               <transition name="fade">
                  <div v-if="showHistoryNotification" @keyup.esc="showHistoryNotification = false" tabindex="0"
                     class="fixed inset-0 bg-gray-500/30 backdrop-blur-md z-50 flex items-center justify-center px-4 py-4">
                     ...
                     <div class="max-w-lg w-full bg-white/20 p-4 rounded-lg shadow-sm">
                        ...
                        <div class="py-2 mb-1 px-1">
                           <div class="flex space-x-1.5 justify-center">
                              <div class="flex text-gray-500 px-3 py-1 rounded-4xl shadow-sm cursor-pointer"
                                 :class="selectFilterNotification == 0 ? 'bg-blue-600 text-white' : 'bg-white/60 '"
                                 @click="selectFilterNotification = 0">
                                 <svg class="w-6 h-6 "
                                    :class="selectFilterNotification == 0 ? 'text-white' : 'text-gray-600'"
                              ...
                              <div class="flex text-gray-500 px-3 py-1 rounded-4xl shadow-sm cursor-pointer"
                                 :class="selectFilterNotification == 1 ? 'bg-blue-600 text-white' : 'bg-white/60 '"
                                 @click="selectFilterNotification = 1">
                                 <svg class="w-6 h-6"
                                    :class="selectFilterNotification == 1 ? 'text-white' : 'text-gray-600'"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    fill="none" viewBox="0 0 24 24">
                              ...
                              <div class="flex text-gray-500 px-3 py-1 rounded-4xl shadow-sm cursor-pointer"
                                 :class="selectFilterNotification == 2 ? 'bg-green-600 text-white' : 'bg-white/60 '"
                                 @click="selectFilterNotification = 2">
                                 <svg class="w-6 h-6"
                                    :class="selectFilterNotification == 2 ? 'text-white' : 'text-gray-600'"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                           ...
                           <template v-if="!loadingShow">
                              ...
                              <div v-if="arrayNotificationTemp.length">
                                 ...
                                 <div v-for="(l, index) in arrayNotificationTemp" v-bind:key="index">
                                    ...
                                    <template
                                       v-if="l.tipo_notificacao == 1 && user.id != l.id_user_manifestacoes && l.id_criador_chamados == user.id">

                                       <div
                                          class="bg-white/70 border-l-4 border-l-blue-600 p-4 rounded-sm shadow-sm mb-2 hover:bg-gray-200 transform duration-500">
                                          ...
                                          <p class="inline-flex text-[8pt] text-gray-500">
                                             ...
                                             <svg class="w-4 h-4 text-gray-500 mr-1" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                                viewBox="0 0 24 24">
                                                <path stroke="currentColor" stroke-linecap="round"
                                                   stroke-linejoin="round" stroke-width="2"
                                             ...
                                             <svg class="w-4 h-4 ml-1 text-gray-500" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                                viewBox="0 0 24 24">
                                                <path stroke="currentColor" stroke-linecap="round"
                                                   stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <template
                                       v-else-if="l.tipo_notificacao == 1 && user.id != l.id_user_manifestacoes && l.id_user_chamados == user.id">
                                    ...
                                    <template v-else-if="l.tipo_notificacao == 0">
                                       ...
                                       <div
                                          class="bg-white/70 border-l-4 border-l-green-600 p-4 rounded-sm shadow-sm mb-2 hover:bg-gray-200 transform duration-500">
                                          <p class="inline-flex text-sm text-gray-600">
                                             <svg class="w-5 h-5 text-gray-600" aria-hidden="true"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                                viewBox="0 0 24 24">
                              ...
                              <div v-else>
                                 <p class="text-gray-500 flex justify-center mt-20 text-[18pt]">
                                    <svg class="w-10 h-10 text-gray-500" aria-hidden="true"
                                       xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                       viewBox="0 0 24 24">
                                       <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                          stroke-width="2"
         ...
         <div class="pb-30" style="font-size: 10pt;">
            <slot></slot>
         </div>
   ...
   <div v-if="showNotification" class="fixed top-5 right-4 px-4 py-2 z-50">
      ...
      <div
         class="bg-red-400 text-white p-2 border-gray-400 w-80 rounded-sm mb-4 shadow-sm animate-pulse hover:animate-none">
   ...
   <Link title="Abrir Novo Ticket" href="/cad/chamado"
      class="fixed bottom-6 right-6 bg-blue-500 hover:bg-blue-700 text-white p-4 rounded-full shadow-2xl">
...
import { requestPermissionAndGetToken, onMessageListener } from '../../firebase.js';
...
export default {
   ...
   mounted() {
      ...
      requestPermissionAndGetToken().then(token => {
         if (token) {
            axios.post('/send/token', { token: token });
            console.log(token);
         }
      });
