<template>
    ...
    <div class="relative">
        ...
        <div v-if="show" class="bg-gray-200 p-2 h-40 overflow-x-auto rounded-2xl mt-2 shadow-lg absolute w-full">

            <div v-for="(l, index) in lista">

                <div class="bg-gray-400 p-2 mb-2 rounded-sm border-gray-300">
